  ...
  const benefits = [
    {
      ...
      description: "Begin your real estate investment journey with minimal capital"
    },
    {
      icon: Shield,
      title: "Secure Platform",
      description: "Blockchain-secured transactions and verified properties"
    },
    {
      icon: Building,
      title: "Diverse Portfolio",
      description: "Access to premium properties across multiple markets"
    }
  ]
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground">
                  Create your account and start investing in tokenized real estate or find your perfect rental property today.
                </p>
              </div>
              ...
              <Card className="w-full max-w-md bg-card/50 backdrop-blur-sm border-border/50 shadow-xl">
                <CardHeader className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    Join thousands of investors and renters
                  </p>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <option value="user">Both investing and renting</option>
                        <option value="investor">Investing only</option>
                        <option value="renter">Renting only</option>
                      </select>
                    </div>
                    ...
                    <div className="flex items-start space-x-2">
                      <input
                        ...
                        id="terms"
                        required
                        className="mt-1 h-4 w-4 text-accent-brand border-border rounded focus:ring-accent-brand"
                      />
                      <label htmlFor="terms" className="text-sm text-muted-foreground">
                        I agree to the{' '}
                        <Link href="/terms" className="text-accent-brand hover:text-accent-brand-dark">
                          Terms of Service
                        </Link>{' '}
                        and{' '}
                        <Link href="/privacy" className="text-accent-brand hover:text-accent-brand-dark">
                          Privacy Policy
                        </Link>
                      </label>
                    </div>
